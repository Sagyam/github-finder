...
import { FaCode, FaStoreAlt, FaUser, FaUserFriends } from 'react-icons/fa'
      ...
      <div className='w-full mx-auto lg:w-10/12 '>
        ...
        <div className='grid grid-cols-1 xl:grid-cols-3 lg:grid-cols-3 md:grid-cols mb-8 md:gap-8'>
          <div className='custom-card-image mb-6 md:mb-0'>
            <div className='rounded-lg shadow-xl card image-full'>
              <figure>
                <img src={avatar_url} alt={name} className='rounded-lg' />
              </figure>
        ...
        <div className='w-full py-5 mb-6 rounded-lg shadow-md bg-base-100 stats'>
          ...
          <div className='stat'>
            ...
            <div className='stat-title pr-5'>Publis Gist</div>
